...
# Set clock uncertainty (setup and hold margin). 
set_clock_uncertainty -setup 0.5 [get_clocks clk]
set_clock_uncertainty -hold 0.1 [get_clocks clk]

# Defining it as an ideal network. The tool will ignore its latency during synthesis.
# Will add real clock tree latency later during Place & Route.
...
# Assuming realistic capacitive load for the output ports
set_load 0.05 [get_ports out_activehigh[*]]
set_load 0.02 [get_ports done] 
# Assuming less load for single bit 'done'
